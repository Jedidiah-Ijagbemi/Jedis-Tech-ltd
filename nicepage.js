!(function (t) {
              ...
              if (!t.isDefaultPrevented()) {
                var e = o(this),
                  ...
                  u =
                    ...
                    (url.startsWith("#") ||
                      (url.indexOf("#") > -1 &&
                        url.indexOf(a.split("#")[0]) > -1));
                if (s && u && window._npScrollAnchor) {
                  var l = url.split("#")[1] || "",
                    c = o("#" + l);
                  c.length &&
                    (window._npScrollAnchor.scroll(c),
  ...
  13549: function (t, e, n) {
              ...
              ? c(form)
                ? f(form)
                  ...
                  : (FormMessage.showError(
                    ...
                    void 0)
                : (FormMessage.showError(form, "The File field is required"),
                  void 0)
    ...
    function u(form, url) {
      ...
      name && ((data.Name = name), (data.FNAME = name));
      ...
      (factory = function () {
        var t = function (template, t, items, e) {
          ...
          var u = function () {
            ...
            ut = {},
            lt = function (name, t) {
              return ut[name] || (ut[name] = []), ut[name].push(t);
            },
            ct = function (name) {
              var t = ut[name];
              if (t) {
            ...
            Rt = function (name) {
              Bt[name] &&
                (Bt[name].raf && j(Bt[name].raf), Ft--, delete Bt[name]);
            },
            Nt = function (name) {
              Bt[name] && Rt(name), Bt[name] || (Ft++, (Bt[name] = {}));
            },
            Ut = function () {
...
*/
  ...
  13572: function (t, e, n) {
    ...
    var Animation = n(13573),
      i = n(312);
    n(693), n(13577), (window.uAnimation = new Animation(i.instance()).init());
  },
      ...
      function createGuid() {
        if (
          ...
          for (var e = [], i = "", o = 0; o < t.length; o++)
            (i = t[o].toString(16)).length < 2 && (i = "0" + i), e.push(i);
          return (
            e.slice(0, 4).join("") +
            "-" +
            e.slice(4, 6).join("") +
